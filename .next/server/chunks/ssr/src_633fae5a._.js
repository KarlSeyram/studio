...
const ebooks = [
    {
        ...
        author: 'Jon Erickson',
        description: 'A comprehensive introduction to the techniques of hacking and creative problem-solving.',
        price: 49.99,
        coverImageId: 'ebook-1'
    },
    {
        id: 2,
        title: 'The Code Book: The Science of Secrecy from Ancient Egypt to Quantum Cryptography',
        author: 'Simon Singh',
        description: 'A history of cryptography, from its use by Mary, Queen of Scots, to its role in modern-day computer encryption.',
        price: 19.99,
        coverImageId: 'ebook-2'
    },
    {
        id: 3,
        title: 'Ghost in the Wires: My Adventures as the World\'s Most Wanted Hacker',
        author: 'Kevin Mitnick',
        description: 'A thrilling true story of the most elusive computer break-in artist in history.',
        price: 14.99,
        coverImageId: 'ebook-3'
    },
    {
        id: 4,
        title: 'The Cuckoo\'s Egg: Tracking a Spy Through the Maze of Computer Espionage',
        author: 'Clifford Stoll',
        description: 'An astrophysicist-turned-sysadmin hunts a hacker and uncovers international espionage.',
        price: 22.99,
        coverImageId: 'ebook-4'
    },
    {
        id: 5,
        title: 'Practical Malware Analysis: The Hands-On Guide to Dissecting Malicious Software',
        author: 'Michael Sikorski',
        description: 'Learn to analyze and understand malware with this practical guide.',
        price: 59.99,
        coverImageId: 'ebook-5'
    },
    {
        id: 6,
        title: 'Social Engineering: The Science of Human Hacking',
        author: 'Christopher Hadnagy',
        description: 'Explore the art of social engineering with real-world examples and techniques.',
        price: 29.99,
        coverImageId: 'ebook-6'
    },
    {
        id: 7,
        title: 'Cybersecurity for Dummies',
        author: 'Joseph Steinberg',
        description: 'A straightforward guide to the basics of cybersecurity and protecting your digital life.',
        price: 24.99,
        coverImageId: 'ebook-7'
    },
    {
        id: 8,
        ...
        price: 18.99,
        coverImageId: 'ebook-8'
    },
    {
        id: 9,
        title: 'Black Hat Python: Python Programming for Hackers and Pentesters',
        author: 'Justin Seitz',
        description: 'Use Python to write network sniffers, manipulate packets, infect virtual machines, and more.',
        price: 34.99,
        coverImageId: 'ebook-9'
    },
    {
        id: 10,
        title: 'The Web Application Hacker\'s Handbook: Finding and Exploiting Security Flaws',
        author: 'Dafydd Stuttard',
        description: 'A comprehensive guide to discovering and exploiting security flaws in web applications.',
        price: 54.99,
        coverImageId: 'ebook-10'
    },
    {
        id: 11,
        title: 'Metasploit: The Penetration Tester\'s Guide',
        author: 'David Kennedy',
        description: 'The definitive guide to the Metasploit Framework for penetration testing.',
        price: 44.99,
        coverImageId: 'ebook-11'
    },
    {
        id: 12,
        title: 'Threat Modeling: Designing for Security',
        author: 'Adam Shostack',
        description: 'A practical guide to finding security flaws before they can be exploited.',
        price: 49.99,
        coverImageId: 'ebook-12'
    }
];
}}),
...
const getBookCategory = (title)=>{
    title = title.toLowerCase();
    if (title.includes('hacking') || title.includes('hacker')) return 'Hacking';
    if (title.includes('cryptography')) return 'Cryptography';
    if (title.includes('malware')) return 'Malware';
    if (title.includes('social engineering')) return 'Social Engineering';
    if (title.includes('python')) return 'Programming';
    if (title.includes('metasploit') || title.includes('pen-testing')) return 'Penetration Testing';
    if (title.includes('threat modeling')) return 'Threat Modeling';
    if (title.includes('cybersecurity') || title.includes('security')) return 'Cybersecurity';
...
function StorePage() {
    ...
    const filteredEbooks = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMemo"])(()=>{
        return __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ebooks"].filter((ebook)=>{
            // Filter by search term
            const lowerCaseSearch = searchTerm.toLowerCase();
            return ebook.title.toLowerCase().includes(lowerCaseSearch) || ebook.author.toLowerCase().includes(lowerCaseSearch);
        }).filter((ebook)=>{
            // Filter by category
            if (selectedCategory === 'All') {
                return true;
            }
            return getBookCategory(ebook.title) === selectedCategory;
        });
    }, [
        searchTerm,
        selectedCategory
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                        ...
                        children: "Browse our curated collection of ebooks on cybersecurity, hacking, and internet technology."
                    }, void 0, false, {
                        fileName: "[project]/src/app/store/page.tsx",
                        lineNumber: 71,
                        columnNumber: 9
            ...
            filteredEbooks.length > 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8",
                children: filteredEbooks.map((ebook)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ebook$2d$card$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["EbookCard"], {
                        ebook: ebook
                    }, ebook.id, false, {
                        fileName: "[project]/src/app/store/page.tsx",
                        lineNumber: 109,
...
//# sourceMappingURL=src_633fae5a._.js.map